 ...
 * 
 */
public class Player2 extends AbstractRecord<Attribute> implements Serializable {
	...
	public Player2(String identifier, String provenance) {
	...
	public boolean equals(Object obj) {
		if(obj instanceof Player2){
			return this.getIdentifier().equals(((Player2) obj).getIdentifier());
		}else
			return false;
	}
