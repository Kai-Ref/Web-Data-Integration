 ...
 * 
 */
public class JerseyNumberMostRecent extends
		AttributeValueFuser<Double, Player, Attribute> {

	public JerseyNumberMostRecent() {
	...
	public void fuse(RecordGroup<Player, Attribute> group, Player fusedRecord, Processable<Correspondence<Attribute, Matchable>> schemaCorrespondences, Attribute schemaElement) {
		...
		double jerseyNumberDouble = fused.getValue();
		int jerseyNumberInt = (int) jerseyNumberDouble;
		
		fusedRecord.setJersey_number(jerseyNumberInt);

		// add provenance info
		fusedRecord.setAttributeProvenance(Player.JERSEY_NUMBER, fused.getOriginalIds());
	}

	@Override
	public boolean hasValue(Player record, Correspondence<Attribute, Matchable> correspondence) {
		return record.hasValue(Player.JERSEY_NUMBER);
	}

	@Override
	public Double getValue(Player record, Correspondence<Attribute, Matchable> correspondence) {
		return (double) record.getJersey_number();
	}
