 ...
 * 
 */
public class PrefferedFootEvaluationRule extends EvaluationRule<Player, Attribute> {
	...
	public boolean isEqual(Player record1, Player record2, Attribute schemaElement) {
		...
		// matter
		return sim.calculate(record1.getPreferred_foot(), record2.getPreferred_foot()) == 1.0;
	}
