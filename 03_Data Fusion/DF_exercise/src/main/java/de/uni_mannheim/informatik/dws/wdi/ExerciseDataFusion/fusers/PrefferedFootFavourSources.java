 ...
 * 
 */
public class PrefferedFootFavourSources extends
		AttributeValueFuser<String, Player, Attribute> {

	public PrefferedFootFavourSources() {
	...
	public void fuse(RecordGroup<Player, Attribute> group, Player fusedRecord, Processable<Correspondence<Attribute, Matchable>> schemaCorrespondences, Attribute schemaElement) {
		...
		fusedRecord.setPreferred_foot(fused.getValue());

		// add provenance info
		fusedRecord.setAttributeProvenance(Player.PREFERRED_FOOT, fused.getOriginalIds());
	}

	@Override
	public boolean hasValue(Player record, Correspondence<Attribute, Matchable> correspondence) {
		return record.hasValue(Player.PREFERRED_FOOT);
	}

	@Override
	public String getValue(Player record, Correspondence<Attribute, Matchable> correspondence) {
		return record.getPreferred_foot();
	}
