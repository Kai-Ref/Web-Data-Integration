 ...
 * 
 */
public class CurrentMarketValueAverage extends
		AttributeValueFuser<Double, Player, Attribute> {

	public CurrentMarketValueAverage() {
	...
	public void fuse(RecordGroup<Player, Attribute> group, Player fusedRecord, Processable<Correspondence<Attribute, Matchable>> schemaCorrespondences, Attribute schemaElement) {
		...
		double currentMarketValueDouble = fused.getValue();
		int wagcurrentMarketValueInt = (int) currentMarketValueDouble;
		
		// set the value for the fused record
		fusedRecord.setCurrent_market_value(wagcurrentMarketValueInt);

		// add provenance info
		fusedRecord.setAttributeProvenance(Player.CURRENT_MARKET_VALUE, fused.getOriginalIds());
	}

	@Override
	public boolean hasValue(Player record, Correspondence<Attribute, Matchable> correspondence) {
		return record.hasValue(Player.CURRENT_MARKET_VALUE);
	}

	@Override
	public Double getValue(Player record, Correspondence<Attribute, Matchable> correspondence) {
		return (double) record.getCurrent_market_value();
	}
