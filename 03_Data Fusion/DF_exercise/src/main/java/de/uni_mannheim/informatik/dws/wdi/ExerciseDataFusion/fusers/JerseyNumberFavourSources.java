 ...
 * 
 */
public class JerseyNumberFavourSources extends
		AttributeValueFuser<Integer, Player, Attribute> {

	public JerseyNumberFavourSources() {
	...
	public void fuse(RecordGroup<Player, Attribute> group, Player fusedRecord, Processable<Correspondence<Attribute, Matchable>> schemaCorrespondences, Attribute schemaElement) {
		...
		fusedRecord.setJersey_number(fused.getValue());
	...
	public Integer getValue(Player record, Correspondence<Attribute, Matchable> correspondence) {
		return record.getJersey_number();
	}
