 ...
 * 
 */
public class FcXMLReader extends XMLMatchableReader<Fc, Attribute>  {

	/* (non-Javadoc)
	 * @see de.uni_mannheim.informatik.wdi.model.io.XMLMatchableReader#initialiseDataset(de.uni_mannheim.informatik.wdi.model.DataSet)
	 */
	@Override
	protected void initialiseDataset(DataSet<Fc, Attribute> dataset) {
		super.initialiseDataset(dataset);
		
	}
	
	@Override
	public Fc createModelFromElement(Node node, String provenanceInfo) {
		String id = getValueFromChildElement(node, "id");

		// create the object with id and provenance information
		Fc player = new Fc(id, provenanceInfo);
